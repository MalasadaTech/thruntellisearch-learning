...
Because the sources aren't limited to the Teams lure, we need to change our topic. In intel collections, the topic is the main thing that you want to collect intel on. It can be a specific campaign, a malware, or a specific threat actor. At this point, I think it'll be a good idea to change the topic to "Malvertizing Fake Apps to Deliver Oyster Malware". With this topic, it'll cover the other Fake Apps too.
## Organization
